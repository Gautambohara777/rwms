...
<body class="bg-gray-100 min-h-screen flex flex-col justify-between">
    <?php
    // The session is now started inside your header.php file
    include "connect.php";
    ...
    <!-- Include your new header file here -->
    ...
    <main class="flex-grow flex items-center justify-center p-4 bg-gradient-custom">
        <div class="flex flex-col md:flex-row w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="w-full md:w-1/2 p-8 flex items-center justify-center bg-gray-100 hidden md:flex">
                <img src="img/recycle_hub_logo.png" alt="Recycle Hub Logo" class="rounded-lg shadow-md max-h-full w-full object-contain">
            </div>
                        ...
                        <div id="login-form-section" class="form-section">
                            <div class="w-full max-w-sm">
                                <div class="text-center mb-8">
                                    <a href="home.php">
                                        <img src="img/recycle_hub_logo.png" alt="Recycle Hub Logo" class="mx-auto w-32 h-32 object-contain">
                                    </a>
                                </div>
